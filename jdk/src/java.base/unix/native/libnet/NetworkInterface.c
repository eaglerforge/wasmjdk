...
JNIEXPORT netif  *enumIPv4Interfaces(JNIEnv *env, int sock, netif *ifs);
JNIEXPORT netif  *enumIPv6Interfaces(JNIEnv *env, int sock, netif *ifs);
...
JNIEXPORT int     openSocketWithFallback(JNIEnv *env, const char *ifname);
...
JNIEXPORT int     getFlags(int sock, const char *ifname, int *flags);
JNIEXPORT int     getMacAddress(JNIEnv *env, const char *ifname,
                             const struct in_addr *addr, unsigned char *buf);
JNIEXPORT int     getMTU(JNIEnv *env, int sock, const char *ifname);
